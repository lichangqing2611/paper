...
- [DeepSeek-V3.2-Exp：通过 DeepSeek 稀疏注意力提升长上下文效率](#deepseek-v32-exp通过-deepseek-稀疏注意力提升长上下文效率)
  - [摘要 (Abstract)](#摘要-abstract)
  - [1. 架构 (Architecture)](#1-架构-architecture)
  - [2. 训练 (Training)](#2-训练-training)
    - [2.1. 持续预训练 (Continued Pre-Training)](#21-持续预训练-continued-pre-training)
    - [2.2. 后训练 (Post-Training)](#22-后训练-post-training)
  - [3. 评估 (Evaluations)](#3-评估-evaluations)
